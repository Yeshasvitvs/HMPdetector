...
void Creator::createSet(mat &actual_sample, mat &set)
{
	...
	noisy_sample(0, 0) = (actual_sample(0, 0) / 65535) * (39.2266);
	noisy_sample(0, 1) = (actual_sample(0, 1) / 65535) * (39.2266);
	noisy_sample(0, 2) = (actual_sample(0, 2) / 65535) * (39.2266);
